...
local backend_id_server = { 5010,5011,5012}
 local replication_dsn = {{ port = 5011, ip = '127.0.0.1', user = 'skysql', password  = 'skyvodka'},{ port = 5012, ip = '127.0.0.1', user = 'skysql', password  = 'skyvodka'}}
